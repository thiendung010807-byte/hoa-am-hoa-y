...
export const event = {
  ...
  timeline: [
    ...
    ["19:20–19:30", "TRỞ VỀ BẮC NINH", "Một minigame nhỏ để cùng nhớ, cùng đoán và khám phá thêm về quê mình."],
    ...
    ["20:45–20:55", "TRAO QUÀ & LƯU KHOẢNH KHẮC", "Nhận những phần quà nhỏ, ăn uống, trò chuyện và lưu lại bức ảnh chung trước khi kết thúc."],
  ],
  questions: [
