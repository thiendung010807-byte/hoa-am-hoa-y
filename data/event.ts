...
export const event = {
  ...
  timeline: [
    ["18:15–19:00", "CHECK-IN", "Đến nhận thông tin, check-in và làm quen với không gian chương trình."],
    ["19:00–19:10", "CHÀO SÂN", "Cùng ổn định chỗ ngồi và bắt đầu buổi gặp mặt."],
    ["19:10–19:40", "HÒA GIỌNG CÙNG NHAU", "Mọi người cùng hát, cùng bắt nhịp và tạo nên một khoảnh khắc chung thật đáng nhớ."],
    ["19:40–19:45", "SẮC MÀU QUÊ HƯƠNG", "Một tiết mục mang âm hưởng Quan họ và những nét văn hóa quen thuộc của Bắc Ninh."],
    ["19:45–19:50", "ĐỔI NHỊP", "Chuyển nhịp bằng một tiết mục trẻ trung, sôi động và giàu năng lượng."],
    ["19:50–20:10", "SÂN KHẤU GIAO LƯU", "Không gian dành cho những tiết mục và màu sắc riêng từ các bạn tham gia chương trình."],
    ["20:10–20:40", "CHUỖI MINIGAME", "Cùng đồng đội vượt qua các thử thách vui tươi, tương tác và khuấy động bầu không khí."],
    ["20:40–20:55", "TRAO QUÀ & LƯU KHOẢNH KHẮC", "Khép lại bằng phần trao quà, giao lưu nhẹ nhàng và lưu lại những bức ảnh chung."],
  ],
  questions: [
