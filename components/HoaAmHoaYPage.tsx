  ...
  return <>
    ...
    {opened && <main>
      ...
      <section className="memories section"><span className="eyebrow">HÒA ÂM HỎA Ý SẼ CÓ…</span><h2>Những thứ đáng để<br/><i>nhớ thật lâu.</i></h2><div className="memory-grid">{[
        ["01","QUAN HỌ MỞ MÀN","Một chút âm thanh quê nhà để bắt đầu buổi tối",<PartyPopper key="m"/>],
        ["02","BẮC NINH TRONG MỘT TRÒ CHƠI","Xem mình nhớ quê mình đến đâu",<UsersRound key="m"/>],
        ["03","SÂN KHẤU CỦA K68","Những tiết mục đến từ chính các bạn tham gia",<Camera key="m"/>],
        ["04","30 PHÚT HÁT CHUNG","Không cần hát hay, chỉ cần chịu hát cùng",<Zap key="m"/>],
        ["05","CHUỖI GAME ĐỒNG ĐỘI","Có những trò mà một người giỏi thôi vẫn chưa đủ",<Music2 key="m"/>],
        ["06","BỨC ẢNH CUỐI BUỔI","Để ngày hôm sau vẫn còn thứ để gửi vào group",<Heart key="m" fill="currentColor"/>]
